...
class EnaCommandProcessor(BaseCommandProcessor):
    ...
    def do_show(self, command, *args, context=None):
        if self._validate(args, 'interface', 'gigaEthernet', str):
        ...
        elif self._validate(args, 'mac', 'address-table', 'interface', 'gigaEthernet', str):
            port_name, = self._dissect(args, 'mac', 'address-table', 'interface', 'gigaEthernet', str)
            bottom_text = ""
            counter = 0
            ...
            try:
                ...
                for s_p in service_ports:
                    ...
                    bottom_text += self._render("show_mac_address_table_interface_gigaEthernet_port_bottom",
            ...
            text = self._render('show_mac_address_table_interface_gigaEthernet_port_top', context=context)
            text += bottom_text
