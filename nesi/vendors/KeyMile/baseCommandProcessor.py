...
class BaseCommandProcessor(base.CommandProcessor):
    ...
    def change_directory(self, path, context=None):
        ...
        if path.startswith('/'):
            ...
            if components[0] in ('main', 'cfgm', 'fm', 'pm', 'status'):
                ...
                self._init_access_points(context=context)  # make sure all management_functions are loaded correctly
    ...
    def _create_command_processor_obj(self, command_processor):
        module_paths = {
            'UnitCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.unitCommandProcessor',
            'PortCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.port.portCommandProcessor',
            'ChanCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.port.chan.chanCommandProcessor',
            'InterfaceCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.port.interface.interfaceCommandProcessor',
            'FanCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.fan.fanCommandProcessor',
            'AlarmCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.fan.alarmCommandProcessor',
            'EoamCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.eoamCommandProcessor',
            'MulticastCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.multicastCommandProcessor',
            'TdmconnectionsCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.tdmconnectionsCommandProcessor',
            'ServicesCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.services.servicesCommandProcessor',
            'PortgroupCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.portgroup.portgroupCommandProcessor',
            'PortgroupportCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.portgroup.port.portgroupportCommandProcessor',
            'LogportsCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.logport.logportsCommandProcessor',
            'LogportCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.unit.logport.port.logportCommandProcessor',
            'PacketCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.services.packetCommandProcessor',
            'MacaccessctrlCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.services.macaccessctrlCommandProcessor',
            'SubpacketCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.services.subpacketCommandProcessor',
            'SrvcCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.services.srvcCommandProcessor',
            'MgmtunitCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.mgmt_unit.mgmtunitCommandProcessor',
            'MgmtportCommandProcessor': 'nesi.vendors.KeyMile.accessPoints.root.mgmt_unit.mgmt_port.mgmtportCommandProcessor',
        }
