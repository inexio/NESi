...
class TestPbn(TestCore):
    PATH = 'test_cases/integration_tests/pbn/'
    DATA = [f for f in listdir('test_cases/integration_tests/pbn/') if
            isfile(join('test_cases/integration_tests/pbn/', f)) and f != 'output.txt']
